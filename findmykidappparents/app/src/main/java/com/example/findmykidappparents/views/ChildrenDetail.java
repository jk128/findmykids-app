...
import com.example.findmykidappparents.viewmodels.ChildrenDetailViewModel;
...
public class ChildrenDetail extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Runnable Timer_Tick = new Runnable() {
        public void run() {
            mQueue.add(childrenDetailViewModel.getChildren().GetData());
...
//        setContentView(R.layout.activity_childrendetail);
        ...
        imageViewListBack = (ImageView) findViewById(R.id.imgListBack);
