...
public class ChildrenActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(ChildrenViewModel.class);
...
//                }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View container = getLayoutInflater().inflate(R.layout.children_row_activity, parent, false);
...
//            return mPredictiveCB.isChecked();
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.childrenName);
        }
